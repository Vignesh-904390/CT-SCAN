...
# PATHS & DEVICE
# ============================
DATA_DIR = "data - 1/CT SCAN DATA"   # <-- CHANGE THIS PATH
MODEL_DIR = "model"
MODEL_PATH = os.path.join(MODEL_DIR, "ct_effnet_best.pth")
...
print("🚀 CT Scan Training Started...\n")
